...
function handleDisconnect() {
  ...
  db.connect((err) => {
    if (err) {
      ...
      setTimeout(handleDisconnect, 2000); // Re-attempt connection after delay
    }
  });
...
app.post("/Players", (req, res) => {
  ...
  const sql =
    "INSERT INTO Players (first_name, last_name, sport, date_of_birth) VALUES (?, ?, ?, ?)";
...
app.put("/Players/:id", (req, res) => {
  ...
  const sql =
    "UPDATE Players SET first_name = ?, last_name = ?, sport = ?, date_of_birth = ? WHERE player_id = ?";

  db.query(
    sql,
    [first_name, last_name, sport, date_of_birth, player_id],
    (err, data) => {
      if (err) {
...
app.post("/Coaches", (req, res) => {
  ...
  const sql =
    "INSERT INTO Coaches (first_name, last_name, experience, sport) VALUES (?, ?, ?, ?)";
...
app.put("/Coaches/:id", (req, res) => {
  ...
  const sql =
    "UPDATE Coaches SET first_name = ?, last_name = ?, experience = ?, sport = ? WHERE coach_id = ?";

  db.query(
    sql,
    [first_name, last_name, experience, sport, coach_id],
    (err, data) => {
      if (err) {
...
app.post("/Doctors", (req, res) => {
  ...
  const sql =
    "INSERT INTO Doctors (first_name, last_name, specialization, institute_id) VALUES (?, ?, ?, ?)";
  db.query(
    sql,
    [first_name, last_name, specialization, institute_id],
    (err, data) => {
      if (err) {
        ...
        if (err.code === "ER_DUP_ENTRY") {
          return res
            .status(409)
            .json({ error: "Duplicate entry for doctor_id" });
        }
        return res.status(500).json({ error: "Failed to add doctor" });
      }
      return res
        .status(201)
        .json({ message: "Doctor added successfully", data });
    }
  );
});
...
app.put("/Doctors/:id", (req, res) => {
  ...
  const sql =
    "UPDATE Doctors SET first_name = ?, last_name = ?, specialization = ?, institute_id = ? WHERE doctor_id = ?";

  db.query(
    sql,
    [first_name, last_name, specialization, institute_id, doctor_id],
    (err, data) => {
      if (err) {
...
app.post("/Sponsors", (req, res) => {
  ...
  const sql =
    "INSERT INTO Sponsors (sponsor_name, sponsorship_amount) VALUES (?, ?)";
  db.query(sql, [name, amount], (err, data) => {
    if (err) {
      ...
      if (err.code === "ER_DUP_ENTRY") {
        return res
          .status(409)
          .json({ error: "Duplicate entry for sponsor_id" });
      }
      return res.status(500).json({ error: "Failed to add sponsor" });
    }
    return res
      .status(201)
      .json({ message: "Sponsor added successfully", data });
  });
});
...
app.put("/Sponsors/:id", (req, res) => {
  ...
  // Corrected SQL query without a trailing comma
  const sql =
    "UPDATE Sponsors SET sponsor_name = ?, sponsorship_amount = ? WHERE sponsor_id = ?";
...
app.post("/events", (req, res) => {
  ...
  db.query(
    ...
    (err, data) => {
      ...
      return res
        .status(201)
        .json({ message: "Event added successfully", data });
    }
  );
});
...
app.post("/institutes", (req, res) => {
  console.log("Received body:", req.body); // Check incoming data
  const { institute_name, city, ranking, sports_type, established_year } =
    req.body; // Extract fields

  const sql =
    "INSERT INTO Institutes (institute_name, city, ranking, sports_type, established_year) VALUES (?, ?, ?, ?, ?)";
  db.query(
    sql,
    [institute_name, city, ranking, sports_type, established_year],
    (err, data) => {
      if (err) {
      ...
      return res
        .status(201)
        .json({ message: "Institute added successfully", data });
    }
  );
});
...
app.put("/institutes/:id", (req, res) => {
  ...
  const sql =
    "UPDATE Institutes SET institute_name = ?, city = ?, ranking = ?, sports_type = ?, established_year = ? WHERE institute_id = ?";
  db.query(
    sql,
    [
      institute_name,
...
app.post("/managers", (req, res) => {
  ...
  db.query(sql, [first_name, last_name], (err, data) => {
    ...
    return res
      .status(201)
      .json({ message: "Manager added successfully", data });
  });
});
...
app.get("/media_broadcasters", (req, res) => {
  ...
  db.query(sql, (err, data) => {
    if (err) {
      ...
      return res
        .status(500)
        .json({ error: "Failed to fetch media broadcasters" });
    }
    return res.status(200).json(data);
  });
});
...
app.post("/media_broadcasters", (req, res) => {
  ...
  const sql =
    "INSERT INTO Media_Broadcasters (broadcaster_name, city, monthly_viewers) VALUES (?, ?, ?)";
  db.query(sql, [broadcaster_name, city, monthly_viewers], (err, data) => {
    ...
    return res
      .status(201)
      .json({ message: "Media broadcaster added successfully", data });
  });
});
...
app.put("/media_broadcasters/:id", (req, res) => {
  ...
  const sql =
    "UPDATE Media_Broadcasters SET broadcaster_name = ?, city = ?, monthly_viewers = ? WHERE broadcaster_id = ?";
  db.query(
    sql,
    [broadcaster_name, city, monthly_viewers, broadcaster_id],
    (err, data) => {
      if (err) {
        console.error("Error updating media broadcaster:", err.message);
        return res
          .status(500)
          .json({ error: "Failed to update media broadcaster" });
      }
      ...
      return res
        .status(200)
        .json({ message: "Media broadcaster updated successfully" });
    }
  );
});
...
app.delete("/media_broadcasters/:id", (req, res) => {
  ...
  db.query(sql, [broadcaster_id], (err, data) => {
    if (err) {
      ...
      return res
        .status(500)
        .json({ error: "Failed to delete media broadcaster" });
    }
    ...
    return res
      .status(200)
      .json({ message: "Media broadcaster deleted successfully" });
  });
});
...
app.get("/sports_facilities", (req, res) => {
  ...
  db.query(sql, (err, data) => {
    if (err) {
      ...
      return res
        .status(500)
        .json({ error: "Failed to fetch sports facilities" });
    }
    return res.status(200).json(data);
  });
});
...
app.post("/sports_facilities", (req, res) => {
  ...
  const sql =
    "INSERT INTO Sports_Facilities (facility_name, location, capacity, facility_type) VALUES (?, ?, ?, ?)";
  db.query(
    sql,
    [facility_name, location, capacity, facility_type],
    (err, data) => {
      if (err) {
      ...
      return res
        .status(201)
        .json({ message: "Sports facility added successfully", data });
    }
  );
});
...
app.put("/sports_facilities/:id", (req, res) => {
  ...
  const sql =
    "UPDATE Sports_Facilities SET facility_name = ?, location = ?, capacity = ?, facility_type  = ? WHERE facility_id = ?";
  db.query(
    sql,
    [facility_name, location, capacity, facility_type, facility_id],
    (err, data) => {
      if (err) {
        console.error("Error updating sports facility:", err.message);
        return res
          .status(500)
          .json({ error: "Failed to update sports facility" });
      }
      ...
      return res
        .status(200)
        .json({ message: "Sports facility updated successfully" });
    }
  );
});
...
app.delete("/sports_facilities/:id", (req, res) => {
  ...
  db.query(sql, [facility_id], (err, data) => {
    if (err) {
      ...
      return res
        .status(500)
        .json({ error: "Failed to delete sports facility" });
    }
    ...
    return res
      .status(200)
      .json({ message: "Sports facility deleted successfully" });
  });
});
...
app.get("/sports_federations", (req, res) => {
  ...
  db.query(sql, (err, data) => {
    if (err) {
      ...
      return res
        .status(500)
        .json({ error: "Failed to fetch sports federations" });
    }
    return res.status(200).json(data);
  });
});
...
app.post("/sports_federations", (req, res) => {
  console.log("Received body:", req.body); // Check incoming data
  const { federation_name, country, contact_number, email, established_year } =
    req.body; // Extract fields

  const sql =
    "INSERT INTO Sports_Federations (federation_name, country, contact_number, email, established_year) VALUES (?, ?, ?, ?, ?)";
  db.query(
    sql,
    [federation_name, country, contact_number, email, established_year],
    (err, data) => {
      if (err) {
        console.error("Error inserting sports federation:", err.message);
        return res
          .status(500)
          .json({ error: "Failed to add sports federation" });
      }
      return res
        .status(201)
        .json({ message: "Sports federation added successfully", data });
    }
  );
});
...
app.put("/sports_federations/:id", (req, res) => {
  ...
  const sql =
    "UPDATE Sports_Federations SET federation_name = ?, country = ?, contact_number = ?, email = ?, established_year = ? WHERE federation_id = ?";
  db.query(
    sql,
    [
      federation_name,
    ...
    (err, data) => {
      if (err) {
        ...
        return res
          .status(500)
          .json({ error: "Failed to update sports federation" });
      }
      ...
      return res
        .status(200)
        .json({ message: "Sports federation updated successfully" });
    }
  );
});
...
app.delete("/sports_federations/:id", (req, res) => {
  ...
  db.query(sql, [federation_id], (err, data) => {
    if (err) {
      ...
      return res
        .status(500)
        .json({ error: "Failed to delete sports federation" });
    }
    ...
    return res
      .status(200)
      .json({ message: "Sports federation deleted successfully" });
  });
});
...
app.put("/Referees/:id", (req, res) => {
  ...
  const sql =
    "UPDATE Referees SET first_name = ?, last_name = ?, experience = ? WHERE referee_id = ?";
  db.query(
    sql,
    [first_name, last_name, experience, referee_id],
    (err, data) => {
      if (err) {
...
app.delete("/Referees/:id", (req, res) => {
  ...
  db.query(sql, [referee_id], (err, data) => {
    ...
    return res
      .status(200)
      .json({ message: "Media referee deleted successfully" });
  });
});
...
app.get("/players/:playerId/doctors/:doctorId", (req, res) => {
  ...
  if (doctor_id !== 0 && player_id === 0) {
    sql = `SELECT p.player_id, p.first_name AS p_f_name ,p.last_name as p_l_name, p.sport, p.age, d.doctor_id, d.first_name, d.last_name, d.specialization
        FROM PlayerView p
